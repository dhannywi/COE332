...
def generate_sites(lat1: float, lat2: float, long1: float, long2: float) -> dict:
    """
    Given upper and lower bounds of latitude and longitude, this function randomly
    ...
    Args:
        ...
        `long1` (float): A lower bound longitude value
        `long2` (float): An upper bound longitude value
